 ...
 *
 * @param maxTimeoutObtain Maximum allowable time to wait for [[TransactionLocks.Lock]] to be available.
 * @param maxTimeoutReturn Maximum allowable time for [[TransactionLocks.Lock]] the lock to be returned.
 ...
 */
case class TransactionLockSettings(
